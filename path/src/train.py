...
parser.add_argument('--emb_network', type=str, default='efficientnet_b0',
                    help='Image embeddings backbone: mb2, efficientnet_b0/b1/b2/b3, resnet18/34/50/101, convnext_tiny/small')
